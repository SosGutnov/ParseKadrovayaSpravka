...
namespace ParseKadrovayaSpravka.models
{
    class Load_temp
    {
        ...
        public Edu_semester Edu_semester { get; set; }
        ...
        public Load_temp(Load load, Employee empl, int semester, int hourly_fund, Edu_semester edu_semester, Group group, string subject, string subject_form, double hours_other, double hours_contact)
        {
            Load = load;
            Empl = empl;
            Semester = semester;
